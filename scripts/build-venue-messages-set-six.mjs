/**
 * Fills VENUE_MESSAGES_SET_SIX in index.html: merges archived sets 1–5 (by venue id),
 * then adds a default body for any city-set-six venue still missing copy.
 *
...
function main() {
  ...
  console.log("VENUE_MESSAGES_SET_SIX:", Object.keys(out).length, "venues;", fromArchive, "from archive;", defaulted, "default bodies");
}
